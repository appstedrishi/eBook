...
//    if (!includeAll) {
//        return  [self stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet URLFragmentAllowedCharacterSet]];//[self stringByAddingPercentEscapesUsingEncoding:encoding];
//    }
//   
