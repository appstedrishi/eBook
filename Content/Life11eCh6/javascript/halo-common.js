...
Halo.loadSuggestedQuestionsForConcept = function(concept, server) {
	if ($('#suggested-questions').length == 0) {
		$(document).ready(function() {
			$('#glossary-sidebar, #glossary-page').append('<div id="suggested-questions" class="suggested-questions glossary-section empty"><h4>Related questions</h4><ul></ul></div>');
