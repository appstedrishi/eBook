...
$(document).ready(function() {
	...
	if($('body > .concept, #top-level > .concept, #review, #overview').length > 0) {
        ...
        var ftr = "<div id='copyright'>Text and figures on this page from LIFE (11th Edition) by David E. Sadava, David M. Hillis, H. Craig Heller and Sally D. Hacker. Copyright &copy; 2017 by Macmillan Learning, Inc. Reprinted (used) by permission of Macmillan Learning, Inc.</div>";
        $('body > .concept, #top-level > .concept, .chapter-end, #overview').append( ftr );
	}
});
...
Halo.TouchEventHandler = function(highlighter) {
  ...
  self.touchesBeganAtPoint = function(x, y) {
                       // alert("halo_common.js touches begin");
